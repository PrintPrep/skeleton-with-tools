// components/tools/pdf-toolkit/Workstation.tsx
// FIXED: Back to working drag-and-drop with visual enhancements
...
interface WorkstationProps {
    ...
    workstationRef: React.RefObject<HTMLDivElement>;
    ...
    onPageDragEnter: (pageId: string) => void;
                                ...
                                <div key={section.id} className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                                        {sectionPages.map((page, index) => {
                                            ...
                                            const isHovered = hoverPageId === page.id && !isDragging;
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    onDragEnter={() => onPageDragEnter(page.id)}
                                                    ...
                                                    className={`group relative bg-white border-2 rounded-lg overflow-hidden transition-all cursor-move hover:shadow-lg
                                                        ${isDragging ? 'opacity-40 scale-95 border-gray-300' : 'border-gray-300 hover:border-[#00BFA6]'}
                                                        ${isHovered ? 'ring-2 ring-[#00BFA6] ring-offset-2 scale-105 shadow-xl' : ''}
                                                    `}
                                                >
                                                    {/* Drag Handle */}
                                                    ...
                                                    {/* Drop Indicator - Visual line when hovering */}
                                                    {isHovered && (
                                                        <div className="absolute -left-1 top-0 bottom-0 w-1 bg-[#00BFA6] shadow-lg z-20 animate-pulse" />
                                                    )}
